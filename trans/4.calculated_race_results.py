...
# MAGIC -- using parquet as
# MAGIC -- select races.race_year, drivers.name as driver_name, constructors.name as team_name, results.position, results.points, 11-results.position as calculated_points from results 
